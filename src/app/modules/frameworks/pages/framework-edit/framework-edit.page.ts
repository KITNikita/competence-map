...
@Component({
  ...
  templateUrl: './framework-edit.page.html',
  styleUrls: ['./framework-edit.page.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class FrameworkEditPageComponent extends AbstractFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log(this.selectedCompetenceIndex);
  }
